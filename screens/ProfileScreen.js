...
export default function ProfileScreen({ username }) {
  const { mode, setMode, accent, setAccent, customColor, setCustomColor, theme, accentColor } = useTheme();
...
const styles = StyleSheet.create({
  ...
  toggleBtn: { flex: 1, borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 1 },
  toggleText: { fontSize: 14, fontWeight: '600' },
  colorRow: { flexDirection: 'row', gap: 14, alignItems: 'center', flexWrap: 'wrap' },
  colorDot: { width: 36, height: 36, borderRadius: 18 },
  logoutBtn: { borderRadius: 14, padding: 18, alignItems: 'center', borderWidth: 1.5, marginTop: 8 },
